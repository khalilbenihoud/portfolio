    ...
    return(
      <footer id="Footer" className="pv4 ph3 ph5-ns tc">
        <div className="ph3 ph5-ns">
          ...
          <p className="f5 fw6 ttu tracked black-70 mb4 tracked-mega">Made with
            ...
            in Paris</p>
            <a className="link dim dib h2 w1 br-100 mr3 " href="#" title="">
              ...
              <a className="link dim gray dib br-100 h2 w1 mr3 " href="#" title="">
